...
const Home: NextPage = () => {
  ...
  const [showConnectionOptions, setShowConnectionOptions] = useState(ConnectionOptions.RainbowKit);
    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
          ...
          <button
            onClick={() =>
              setShowConnectionOptions(
                showConnectionOptions === "RainbowKit" ? "Sophon Global Account" : "RainbowKit"
              )
            }
            style={{
              padding: "0.5rem 1rem",
        ...
        <h1 className={styles.title}>
          ...
          <a href="https://wagmi.sh">wagmi</a> + <a href="https://nextjs.org">Next.js!</a>
        </h1>
