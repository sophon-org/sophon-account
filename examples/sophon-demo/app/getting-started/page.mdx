...
The **Sophon Account SDK** is a comprehensive SDK built on top of [dynamic.xyz](https://dynamic.xyz/), designed to provide a seamless and secure way to manage user accounts and authentication in your Web3 applications.
...
```sh
pnpm add @sophon-labs/account-ei6963
```
...
import "@sophon-labs/account-ei6963";
