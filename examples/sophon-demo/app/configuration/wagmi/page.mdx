...
<EyeBrown label="Wagmi Configuration" />;
...
>
  ...
  to add the desired chains in your Dynamic dashboard before configuring them here.
</Alert>
...
export default function ChainSwitcher() {
  ...
  return <button onClick={() => switchChain({ chainId: sophon.id })}>Switch to Sophon</button>;
}
```
